...
const openai = new OpenAI({
  ...
  defaultHeaders: {
    "HTTP-Referer": process.env.APP_URL || "https://wallets-monitor.app", // 可选，用于在openrouter.ai排名中显示
    "X-Title": "Wallets Monitor", // 可选，在openrouter.ai排名中显示的应用名称
  },
});
...
${promptSuffix}`;
    ...
    const response = await openai.chat.completions.create({
      model: "deepseek/deepseek-r1:free", // 使用OpenRouter上可用的高级模型
      messages: [
        {
          role: "system",
          content:
